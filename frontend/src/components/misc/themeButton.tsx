...
export default function ThemeButton() {
  ...
  useIsomorphicLayoutEffect(() => {
    ...
    const observer = new MutationObserver(() => {
      setCurrentTheme(html_element.getAttribute("data-theme") === "light" ? "light" : "dark");
    });

    observer.observe(html_element, {
      attributes: true,
    });
  }, []);
  ...
  return (
    <label className="swap swap-rotate">
      ...
      <input type="checkbox" checked={currentTheme === "dark"} onChange={() => {}} />
